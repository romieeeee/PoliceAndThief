...
VALUES (1, '맨홀 촬영하기', '경찰의 포위망이 좁혀오고 있습니다! 주변의 맨홀을 촬영하여 하수도를 통해 탈출 경로를 확보하세요.', NOW(), NOW(), false),
       ...
       (12, '농구 골대 촬영하기', '경찰의 포위망이 좁혀오고 있습니다! 주변의 농구 골대를 촬영하여 당신의 위치를 추적하지 못하게 만드세요.', NOW(), NOW(),
